...
import com.example.mobilesafety.R.layout.activity_report
...
class Report : AppCompatActivity() {
   lateinit var toggle: ActionBarDrawerToggle
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(activity_report)
        ...
        navView.setNavigationItemSelectedListener {
            ...
            when (it.itemId) {
                R.id.nav_home -> {
                    ...
                    val intent = Intent(this@Report, Report::class.java)
                    startActivity(intent)
                }
                R.id.nav_audioRec -> {

                    Toast.makeText(applicationContext, "Start recording", Toast.LENGTH_SHORT).show()
                    val intent = Intent(this@Report, AudioRecord::class.java)
                    startActivity(intent)
                }
                ...
                R.id.nav_complaints -> {
                    ...
                    Toast.makeText(applicationContext, "Send us your complaints", Toast.LENGTH_SHORT)
                        .show()
                    val intent = Intent(this@Report, ComplaintActivity2::class.java)
                    startActivity(intent)
                }
                R.id.nav_find -> {
                    Toast.makeText(applicationContext, "Clicked Map", Toast.LENGTH_SHORT).show()
                    val intent = Intent(this@Report, MapsActivity::class.java)
                    startActivity(intent)
                }
                R.id.nav_contact -> {
                    Toast.makeText(applicationContext, "Contact us today", Toast.LENGTH_SHORT).show()
                    val intent = Intent(this@Report, Contact::class.java)
                    startActivity(intent)
                }
                R.id.nav_logout -> {
                    Toast.makeText(applicationContext, "Logged Out", Toast.LENGTH_SHORT).show()
                    val intent = Intent(this@Report, Login::class.java)
                    startActivity(intent)
                    finish();
                }
            }
